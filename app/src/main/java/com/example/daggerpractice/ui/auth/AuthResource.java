...
/**
 * From https://developer.android.com/jetpack/docs/guide#best-practices
 * This is only a wrapper class for retrofit request so we can act on different states of the request.
 * @param <T>
 */
